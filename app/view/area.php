        ...
        <article id="content">
            <div class="container-fluid">
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    <div class="col col-xs-1">
                                        <img src="../../static/img/menu/area.png" height="75">
                                    </div>
                                ...
                                <table class="table table-hover table-bordered table-responsive table-striped" id="tdatos">
                                    ...
                                    <tbody id="tdetalle">
                                        ...
                                        foreach ($areas as $area) {
                                            ...
                                            ?>
                                            <tr>
                                                <td align="center"><?= $area->getIdArea() ?></td>
                                                <td align="center"><?= $area->getDescripcion() ?></td>
                ...
                <div class="container modal" id="mymodal">
                    <div id="dialog" title="Mantenimiento de Areas" >
                        <form class="form-horizontal " role="form" id="frmArea">
                            <input type="hidden" name="idArea" id="_idArea" value="0"/>
