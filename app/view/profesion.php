        ...
        <article id="content">
            <div class="container-fluid">
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    <div class="col col-xs-1">
                                        <img src="../../static/img/menu/profesion.png" height="75">
                                    </div>
                                ...
                                <table class="table table-hover table-bordered table-responsive table-striped" id="tdatos">
                                    ...
                                    <tbody id="tdetalle">
                                        ...
                                        foreach ($profesiones as $profesion) {
                                            ...
                                            $id = $profesion->getIdProfesion();
                                            ?>
                                            <tr>
                                                <td align="center"><?= $profesion->getIdProfesion() ?></td>
                                                <td align="center"><?= $profesion->getDescripcion() ?></td>
                ...
                <div class="container modal" id="mymodal">
                    <div id="dialog" title="Mantenimiento de Profesiones" >
                        <form class="form-horizontal " role="form" id="frmProfesion">
                            <input type="hidden" name="idProfesion" id="_idProfesion" value="0"/>
                ...
                $('#tdatos #tdetalle').on('click', 'a[rel="edit"]', function () {
                    ...
                    $.ajax({
                        ...
                        success: function (json, textStatus, jqXHR) {
                            $('#_opc').val('M');
                            $('#_idProfesion').val(json.id_profesion);
