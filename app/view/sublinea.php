        ...
        <article id="content">
            <div class="container-fluid">
                                ...
                                <table class="table table-hover table-bordered table-responsive table-striped" id="tdatos">
                                    ...
                                    <tbody id="tdetalle">
                                        ...
                                        foreach ($sublineas as $sublinea) {
                                            ...
                                            $id = $sublinea->getIdSublinea();
                                            ?>
                                            <tr>
                                                <td align="center"><?= $sublinea->getIdSublinea() ?></td>
                                                <td align="center"><?= $sublinea->getDescripcion() ?></td>
                                                <td align="center"><?= $sublinea->getIdLinea() ?></td>
                ...
                <div class="container modal" id="mymodal">
                    <div id="dialog" title="Mantenimiento de Sublineas de Investigación" >
                        <form class="form-horizontal " role="form" id="frmSublinea">
                            <input type="hidden" name="idSublinea" id="_idSublinea" value="0"/>                      
                            ...
                            <div id="tabs">
                                ...
                                <div id="tabs-1">
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-4">
                                            <input type="text"  class="form-control" id="_descripcion" name="descripcion" placeholder="Ingrese solo letras" maxlength="200"  required="true"onfocusout="this.value=this.value.toUpperCase()" required="true" onfocusout="this.value=this.value.toUpperCase()"  >
                                        </div>
                                        <label class="control-label col-xs-2">Linea:</label>
                                        <div class="col-xs-4">
                                            <select class="form-control" id="_id_linea" name="idLinea" <?php if ($Sesion->getIdTipoUsuario() == 3) { ?> disabled="" <?php } ?>>
                                                <?php
                                                $lineas = ctrLinea::getLineas();
                                                foreach ($lineas as $linea) {
                                                    ?>
                                                    <option value="<?= $linea->getIdLinea() ?>"><?= $linea->getDescripcion() ?></option>
                                                    <?php
                                                }
                                                ?>     
                ...
                $('#tdatos #tdetalle').on('click', 'a[rel="edit"]', function () {
                    ...
                    $.ajax({
                        ...
                        success: function (json, textStatus, jqXHR) {
                            $('#_opc').val('M');
                            $('#_idSublinea').val(json.id_sublinea);
                            $('#_descripcion').val(json.descripcion);
                            $('#_id_linea').val(json.id_linea);
