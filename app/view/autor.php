...
<html>
    <head>
        ...
        <?php require '../../app/controller/ctrProfesion.php'; ?>
    </head>
    <body>
        <header>
        ...
        <article id="content">
            <div class="container-fluid">
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    <div class="col col-xs-1">
                                        <img src="../../static/img/menu/autor.png" height="65">
                                    </div>
                                    ...
                                    <tbody id="tdetalle">
                                        ...
                                        foreach ($autores as $autor) {
                                            ...
                                            <tr>
                                                ...
                                                <td align="center"><?= $autor->getCedula() ?></td>
                                                <td align="center"><?= $autor->getNombre() ?></td>
                                                <td align="center"><?= $autor->getApellido() ?></td>
                                                <td align="center"><?= $autor->getTelefono() ?></td>
                                                <td align="center"><?= $autor->getCorreo() ?></td>
                                                <td align="center"><?= $autor->getIdProfesion() ?></td>
                ...
                <div class="container modal" id="mymodal">
                    <div id="dialog" title="Mantenimiento de tipos de autores" >
                        <form class="form-horizontal " role="form" id="frmAutor">
                            <input type="hidden" name="idAutor" id="_idAutor" value="0"/>                      
                            ...
                            <div id="tabs">
                                ...
                                <div id="tabs-1">
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-4">
                                            <input type="text"  class="form-control" id="_cedula" name="cedula" placeholder="Ingrese solo numeros" maxlength="10" required="true" pattern="[0-9]{10}" onkeypress="return controltag(event)" >
                                        </div>
                                        <label class="control-label col-xs-2">Nombre:</label>
                                        <div class="col-xs-4">
                                            <input type="text" class="form-control" id="_nombre" name="nombre" placeholder="Ingrese solo letras" maxlength="100" required="true" onfocusout="this.value=this.value.toUpperCase()">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-4">
                                            <input type="text" class="form-control" id="_apellido" name="apellido" placeholder="Ingrese solo letras" maxlength="100" required="true" onfocusout="this.value=this.value.toUpperCase()" required="true" onfocusout="this.value=this.value.toUpperCase()">
                                        </div>
                                        <label class="control-label col-xs-2">Telefono:</label>
                                        <div class="col-xs-4">
                                            <input type="tel"  class="form-control" id="_telefono" name="telefono" placeholder="Ingrese solo numeros" maxlength="15" required="true" pattern="[0-9]{10}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-4">
                                            <input type="tel"  class="form-control" id="_correo" name="correo" placeholder="Ingrese correo"  required="true" maxlength="100" >
                                        </div>
                                        <label class="control-label col-xs-2">Tipo:</label>
                                        <div class="col-xs-4">
                                            <select class="form-control" id="_id_profesion" name="idProfesion" <?php if ($Sesion->getIdTipoUsuario() == 3) { ?> disabled="" <?php } ?> >
                                                <?php
                                                $profesiones = ctrProfesion::getProfesiones();
                                                foreach ($profesiones as $profesion) {
                                                    ?>
                                                    <option value="<?= $profesion->getIdProfesion() ?>"><?= $profesion->getDescripcion() ?></option>
                                                    <?php
                                                }
                                                ?>                        
                                            </select>
        ...
        <script>
                                                ...
                                                $(function () {
                                                    ...
                                                    $('#btnnuevo').click(function () {
                                                        ...
                                                        $('#_id_profesion').chosen({width: "100%"});
                                                    });
                                                    ...
                                                    $('#tdatos #tdetalle').on('click', 'a[rel="edit"]', function () {
                                                        ...
                                                        $.ajax({
                                                            ...
                                                            success: function (json, textStatus, jqXHR) {
                                                                ...
                                                                $('#_id_profesion').val(json.id_profesion);
