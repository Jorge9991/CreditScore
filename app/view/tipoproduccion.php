    ...
    <body>
        ...
        <article id="content">
            <div class="container-fluid">
                        ...
                        <div class="panel panel-default panel-table panel-info">
                            <div class="panel-heading">
                                <div class="row">
                                    <div class="col col-xs-1">
                                        <img src="../../static/img/menu/tipoProducción.jpg" height="65">
                                    </div>
                                    <div class="col col-xs-3">
                                        <h3>Listado De Tipo de Produccion </h3>
                                    </div>                                    
                                </div>
                                <br>
                                <div class="row">
                            ...
                            <div class="panel-body">
                                <table class="table table-hover table-bordered table-responsive table-striped" id="tdatos">
                                    ...
                                    <tbody id="tdetalle">
                                        <?php
                                         $tipoproduccion = ctrTipoProduccion::getTipoProducciones();
                                        foreach ($tipoproduccion as $tipoproducciones) {
                                           
                                                $id = $tipoproducciones->getIdTipoProduccion();
                                                ?>
                                                <tr>
                                                    <td align="center"><?= $tipoproducciones->getIdTipoProduccion() ?></td>
                                                    <td align="center"><?= $tipoproducciones->getDescripcion() ?></td>
                ...
                <div class="container modal" id="mymodal">
                    <div id="dialog" title="Mantenimiento de Tipo de Producción" >
                        <form class="form-horizontal " role="form" id="frmTipoProduccion">
                            <input type="hidden" name="idTipoProduccion" id="_idTipoProduccion" value="0"/>
                            ...
                            <div id="tabs">
                                ...
                                <div id="tabs-1">
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-4">
                                            <input type="text"  class="form-control" id="_descripcion" name="descripcion" placeholder="Ingrese solo letras" maxlength="100"  required="true" onfocusout="this.value=this.value.toUpperCase()" required="true" onfocusout="this.value=this.value.toUpperCase()">
                                        </div>
       ...
       // patron =/[0-9\s]/;// -> solo letras
        ...
        return patron.test(te);
            ...
            $(function () {
                $('#frmTipoProduccion').on({
                    submit: function () {
                      var form = $('#frmTipoProduccion');
                        var disabled = form.find(':input:disabled').removeAttr('disabled');
                        var serialized = form.serialize();
                        disabled.attr('disabled','disabled');
                        $.ajax({
                            url: "tipoproduccionopc.php",
                            data: serialized,
                            type: 'POST',
                            dataType: 'json',
                ...
                $('#tdatos #tdetalle').on('click', 'a[rel="edit"]', function () {
                    ...
                    $.ajax({
                        ...
                        success: function (json, textStatus, jqXHR) {
                            $('#_opc').val('M');
                            $('#_idTipoProduccion').val(json.id_tipo_produccion);
