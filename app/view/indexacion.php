    ...
    <body>
        ...
        <article id="content">
            <div class="container-fluid">
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    <div class="col col-xs-1">
                                        <img src="../../static/img/menu/indexacion.png" height="65">
                                    </div>
                                    <div class="col col-xs-3">
                                        <h3>Listado De Indexaciones</h3>
                                    </div>                                    
                                </div>
                                <br>
                                <div class="row">
                                ...
                                <table class="table table-hover table-bordered table-responsive table-striped" id="tdatos">
                                    ...
                                    <tbody id="tdetalle">
                                        ...
                                        foreach ($indexaciones as $indexacion) {
                                            ...
                                            $id = $indexacion->getIdIndexacion();
                                            ?>
                                            <tr>
                                                <td align="center"><?= $indexacion->getIdIndexacion() ?></td>
                                                <td align="center"><?= $indexacion->getDescripcion() ?></td>
                ...
                <div class="container modal" id="mymodal">
                    <div id="dialog" title="Mantenimiento de Indexación" >
                        <form class="form-horizontal " role="form" id="frmIndexacion">
                            <input type="hidden" name="idIndexacion" id="_idIndexacion" value="0"/>
        ...
        <script>
            ...
            $(function () {
                $('#frmIndexacion').on({
                    submit: function () {
                        var form = $('#frmIndexacion');
                        var disabled = form.find(':input:disabled').removeAttr('disabled');
                        var serialized = form.serialize();
                        disabled.attr('disabled', 'disabled');
                        $.ajax({
                            url: "indexacionopc.php",
                            data: serialized,
                            type: 'POST',
                            dataType: 'json',
                ...
                $('#tdatos #tdetalle').on('click', 'a[rel="edit"]', function () {
                    ...
                    $.ajax({
                        ...
                        success: function (json, textStatus, jqXHR) {
                            $('#_opc').val('M');
                            $('#_idIndexacion').val(json.id_indexacion);
