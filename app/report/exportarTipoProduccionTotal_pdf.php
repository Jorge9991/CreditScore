...
$datos = $impr->listarTodo($tipoproduccion);
...
$content .= '
		...
		<div class="row">
	        ...
	        <h2 style="text-align:center;"> Reporte general de producción científica </h3>
	        ...
	        <br>
                  <table>
                     <thead>
                        <tr bgcolor="#E5E5E5">
                                <th  align="center"><h4>Codigo</h4></th>                                          
...
for ($x = 0; $x < count($datos); $x++) {
    ...
    $content .= '
		<tr nobr="true" bgcolor="#f5f5f5">
                ...
                <td align="center">' . $isnn . '</td>
                <td align="center">' . $fecha . '</td>
                <td align="center">' . $rev . '</td>
                <td align="center">' . $tipo . '</td>
                <td align="center">' . $area . '</td>
                <td align="center">' . $obser . '</td>    
        </tr>
	';
}
...
$pdf->output('../temp/reporteTipoProduccionTotal.pdf', 'F');
?>