...
$datos = $impr->buscarTipoUsuario($tipo);
...
$content .= '
		...
		<div class="row">		
        	<div class="col-md-12">
                ...
                <h3 style="text-align:center;"> Reporte Tipo Usuario </h3>
...
for ($x = 0; $x < count($datos); $x++) {
    ...
    $direc = $datos[$x]['direccion'];
    $tel = $datos[$x]['telefono'];
    $corr = $datos[$x]['correo'];
    $usuario = $datos[$x]['usuario'];
    $tip = $datos[$x]['idTipoUsuario'];
...
$pdf->output('../temp/reporteUsuario.pdf', 'F');
?>
