...
class ctrUsuario {
    ...
    public static function getUsuariosInvestigaciones() {
        $usuarioDao = new daoUsuario();
        return $usuarioDao->listarUsuariosInvestigacion();
    }

    public static function getUsuariosJurados() {
        $usuarioDao = new daoUsuario();
        return $usuarioDao->listarUsuariosJurado();
    }

    public static function getUsuariosEstudiantes() {
        $usuarioDao = new daoUsuario();
        return $usuarioDao->listarUsuariosEstudiante();
    }
